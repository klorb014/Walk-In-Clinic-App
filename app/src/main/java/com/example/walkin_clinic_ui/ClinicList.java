...
public class ClinicList extends ArrayAdapter<WalkinClinic> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewName = (TextView) listViewItem.findViewById(R.id.textViewClinicListName);
        TextView textViewRole = (TextView) listViewItem.findViewById(R.id.textViewClinicListAddress);
