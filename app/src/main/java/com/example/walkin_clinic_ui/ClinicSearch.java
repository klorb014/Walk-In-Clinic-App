...
public class ClinicSearch extends AppCompatActivity {
    ...
    private void showClinicSearchDialog() {
    ...
    public void onClickSearch(View view){
        ...
        System.out.println("num of clinics before = " + clinics.size());
                    ...
                    for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                        ...
                        if(searchAddress.equals(address)){
                            ...
                            if(hasService && correctStartTime){
                                ...
                                clinics.add(clinic);
                                System.out.println("num of clinics after = " + clinics.size());
                            }
    ...
    public void onBookAppt (View view) {
